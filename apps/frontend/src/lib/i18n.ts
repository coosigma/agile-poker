...
export const STRINGS: Record<Language, Record<string, string>> = {
	en: {
		...
		roomNamePlaceholder: 'Sprint 42 planning',
		roomNameRequiredError: 'Please give the room a name.',
		roleLabel: 'Role',
		playerRole: 'Player',
	...
	zh: {
		...
		nickname: '昵称',
		roomNameLabel: '房间名称',
		roomNamePlaceholder: '第 42 迭代排期',
		roomNameRequiredError: '请填写房间名称。',
		roleLabel: '角色',
		playerRole: '玩家',
	...
	ja: {
		...
		nickname: '表示名',
		roomNameLabel: '部屋名',
		roomNamePlaceholder: 'スプリント42計画',
		roomNameRequiredError: '部屋名を入力してください。',
		roleLabel: '役割',
		playerRole: 'プレイヤー',
